...
class Usuario extends \AppBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'idUsuario', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'nome', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'usuario', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'senha'];
        }
